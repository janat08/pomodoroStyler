...
import {TimerModal} from './timer.js'
                ...
                <section class="accordions">
                    <article class="accordion is-active">
                        ...
                        <div class="accordion-body">
                            <div class="accordion-content">
                                ...
                                <GenerateSoundSelect kind="Work end sound" field="workSound"></GenerateSoundSelect>
                                <GenerateSoundSelect kind="Break end sound" field="breakSound"></GenerateSoundSelect>
                                <GenerateSoundSelect kind="Big break end sound" field="bigBreakSound"></GenerateSoundSelect>
                                <div class="field is-horizontal">
                                    <div class="field-label">
                    ...
                    <article class="accordion is-active">
                        <div class="accordion-header toggle">
                            ...
                            <p>Donations and Tips (Mining {s.s.amountToMine == 100 || !s.noSync.minerOn ? "Off" : "On"})</p>
                        </div>
                        <div class="accordion-body">
                            <div class="accordion-content">
